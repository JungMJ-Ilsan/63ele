...
export function Age4050() {
  return (
    <PolicyPageTemplate stage="age">
      <div className="min-h-screen bg-gradient-to-b from-amber-50 via-white to-orange-50 -mt-20 pt-20 flex items-center justify-center">
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          >
            <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-full font-bold shadow-lg mb-8">
              <Clock size={24} />
            </div>
