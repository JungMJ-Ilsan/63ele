...
export function Age2030() {
  return (
    <PolicyPageTemplate stage="age">
      <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-cyan-50 -mt-20 pt-20 flex items-center justify-center">
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          >
            <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-full font-bold shadow-lg mb-8">
              <Clock size={24} />
            </div>
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-white p-8 sm:p-12 md:p-16">
              ...
              <div className="relative z-10 space-y-8">
                <div className="flex justify-center mb-6">
                  <AlertCircle className="text-blue-600" size={64} />
                </div>
