        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-3xl font-bold text-gray-900">스마트 행정 서비스</h2>
            </div>
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              디지털 기술을 활용하여 주민들이 더 편리하게 행정 서비스를 이용할 수 있도록 하겠습니다.
            </p>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <span className="text-orange-500 text-xl mt-1">✓</span>
                <span className="text-gray-700 text-lg">24시간 온라인 민원 처리 시스템</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-orange-500 text-xl mt-1">✓</span>
                <span className="text-gray-700 text-lg">AI 상담 챗봇 도입</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-orange-500 text-xl mt-1">✓</span>
                <span className="text-gray-700 text-lg">모바일 앱 기반 지역 서비스</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-orange-500 text-xl mt-1">✓</span>
                <span className="text-gray-700 text-lg">어르신 맞춤 디지털 교육</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 border-2 border-orange-200">
            ...
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              지역 청년들이 고향에서 꿈을 펼칠 수 있도록 양질의 일자리를 만들겠습니다.
            </p>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <span className="text-orange-500 text-xl mt-1">✓</span>
