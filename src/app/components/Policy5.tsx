        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-4">
              탄현의 품에서 미래 전문가로,<br />
              <span className="text-orange-500 font-bold">우리 동네 내일을 코딩합니다</span>
            </p>
            <p className="text-gray-600 leading-relaxed">
              탄현에서 나고 자란 IT 전문가로서, 첨단 기술과 따뜻한 지역사회가 공존하는 미래를 만들어가겠습니다.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-3xl font-bold text-gray-900">스마트시티 구축</h2>
            </div>
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              첨단 기술로 주민들의 삶을 더 편리하고 안전하게 만들겠습니다.
            </p>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <span className="text-orange-500 text-xl mt-1">✓</span>
                <span className="text-gray-700 text-lg">무료 공공 Wi-Fi 전역 설치</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-orange-500 text-xl mt-1">✓</span>
                <span className="text-gray-700 text-lg">AI 기반 행정 서비스</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-orange-500 text-xl mt-1">✓</span>
                <span className="text-gray-700 text-lg">스마트 가로등 및 CCTV</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-orange-500 text-xl mt-1">✓</span>
                <span className="text-gray-700 text-lg">디지털 민원 시스템</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 border-2 border-orange-200">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-3xl font-bold text-gray-900">지역 발전 비전</h2>
            </div>
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              탄현의 미래를 위한 장기적인 발전 계획을 추진하겠습니다.
            </p>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <span className="text-orange-500 text-xl mt-1">✓</span>
                <span className="text-gray-700 text-lg">친환경 에너지 전환</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-orange-500 text-xl mt-1">✓</span>
              ...
              <li className="flex items-start gap-3">
                <span className="text-orange-500 text-xl mt-1">✓</span>
                <span className="text-gray-700 text-lg">지역 상권 활성화</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-orange-500 text-xl mt-1">✓</span>
                <span className="text-gray-700 text-lg">교통 인프라 개선</span>
              </li>
            </ul>
          </div>
        </div>
